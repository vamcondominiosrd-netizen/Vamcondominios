...
export default function MovilSolicitudesPresidentePage() {
  ...
  useEffect(() => {
    ...
    if (!autorizado) {
      alert("Su usuario no tiene permiso para aprobar como presidente.");
      router.push("/movil");
      return;
    }
          ...
          <div className="space-y-4">
            ...
            {solicitudes.length === 0 && (
              <div className="bg-white rounded-3xl p-6 text-center text-slate-500 border">
                No hay solicitudes pendientes para aprobación del presidente.
              </div>
            )}
          </div>
        )}
