...
export default function CodigosActivacionPropietariosPage() {
  ...
  return (
    <main className="min-h-dvh bg-slate-100 px-3 py-4 sm:px-5">
      <div className="mx-auto w-full max-w-3xl">
        <header className="overflow-hidden rounded-[1.75rem] bg-gradient-to-r from-blue-900 to-slate-950 text-white shadow-xl">
          <div className="flex items-center gap-3 px-4 py-4 sm:px-6">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-blue-100">
                Acceso inicial de propietarios
              </p>
            </div>

            <ShieldCheck className="ml-auto h-6 w-6 text-blue-100" />
          </div>
        </header>
