          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <button
                ...
                className="inline-flex h-11 items-center gap-2 rounded-xl bg-emerald-700 px-4 text-sm font-black text-white hover:bg-emerald-800"
              >
              ...
              <button
                ...
                className="inline-flex h-11 items-center gap-2 rounded-xl bg-blue-800 px-4 text-sm font-black text-white hover:bg-blue-900"
              >
