    ...
    <main className="min-h-screen bg-slate-100 p-4 md:p-8">
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <section className="rounded-2xl border border-blue-200 bg-blue-50 p-4 text-sm text-blue-800">
          Esta versión permite consultar, desbloquear, activar e inactivar
          cuentas de propietarios. Al inactivar una cuenta se cierran sus sesiones
          activas. La contraseña actual nunca se muestra.
        </section>
      </div>
    </main>
  );
