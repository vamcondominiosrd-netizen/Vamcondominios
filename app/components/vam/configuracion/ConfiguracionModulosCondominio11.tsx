  ...
  return (
    <main className="min-h-screen bg-slate-100 p-4 md:p-7">
      <div className="mx-auto max-w-7xl space-y-5">
        <header className="overflow-hidden rounded-3xl bg-gradient-to-r from-slate-950 via-blue-950 to-blue-800 p-6 text-white shadow-xl md:p-8">
          <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-3xl text-sm leading-6 text-blue-100">
                {condominioNombre || "Cargando condominio..."}. Esta pantalla
                define qué áreas de VAM están disponibles según el servicio
                contratado.
              </p>
            </div>
            ...
            <button
              ...
              onClick={() => void cargar()}
              disabled={loading}
              className="inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-white/10 px-4 text-sm font-black text-white ring-1 ring-white/20 transition hover:bg-white/20 disabled:opacity-60"
            >
        ...
        <section className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          <Indicador
            ...
            detalle="Catálogo activo de VAM"
            icono={Settings}
          />
          <Indicador
            titulo="Módulos habilitados"
            valor={String(habilitados)}
            detalle="Visibles para este condominio"
            icono={CheckCircle2}
          />
          <Indicador
            titulo="Módulos obligatorios"
            valor={String(obligatorios)}
            detalle="No pueden deshabilitarse"
            icono={LockKeyhole}
          />
        </section>
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                {editable
                  ...
                  : "El representante puede consultar los módulos habilitados, pero solamente VAM puede modificar el plan contratado."}
              </p>
            </div>

            <div className="flex h-11 w-full items-center rounded-xl border bg-slate-50 px-3 md:w-80">
        ...
        {loading ? (
          <div className="rounded-3xl border bg-white p-12 text-center text-sm font-bold text-slate-500">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex flex-wrap items-start justify-between gap-3">
            ...
            <button
              ...
              onClick={onToggle}
              disabled={
                !editable || procesando || (modulo.obligatorio && modulo.habilitado)
              }
