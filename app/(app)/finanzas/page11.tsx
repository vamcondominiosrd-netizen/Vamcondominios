  ...
  const secciones: SeccionFinanzas[] = [
    ...
    },
    {
      ...
      modulos: [
        ...
        {
        titulo: "Pago Agrupado (Prueba)",
        descripcion: 
          "Registrar varias facturas de un mismo proveedor y generar un solo cheque.",
        href: "/solicitudes-pago/agrupada-prueba",
        icono: ClipboardCheck,
        fondo: "from-violet-600 to-purple-800",
