    ...
    <>
      <PageContainer>
        <PageHeader
          ...
          subtitle={`Creación, asignación de roles y control de acceso del personal. Condominio activo: ${
          ...
          action={
            <div className="flex flex-wrap gap-2">
              ...
              <button
                ...
                disabled={cargando}
                className="inline-flex items-center gap-2 rounded-xl border bg-white px-4 py-2.5 text-sm font-bold text-slate-700 hover:bg-slate-50 disabled:opacity-50"
              >
                <RefreshCw
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
          <StatCard
            ...
            subtitle="Registrados en el condominio"
            icon={Users}
            tone="blue"
          />
          ...
          <StatCard
            ...
            value={roles.length}
            subtitle="Asignables al personal"
            icon={ShieldCheck}
            tone="slate"
          />
        </div>
        ...
        <SectionCard
          ...
          subtitle={`Usuarios asociados a ${
            condominioNombre || "el condominio activo"
          }, sus roles y estado de acceso.`}
        >
          <ActionBar
            search={busqueda}
                      ...
                      <td className="px-4 py-3 text-center">
                        <div className="flex flex-wrap justify-center gap-2">
                          <button
                            type="button"
                            onClick={() => seleccionarUsuario(usuario)}
                            className="inline-flex items-center gap-1.5 rounded-lg bg-slate-700 px-3 py-1.5 text-xs font-bold text-white hover:bg-slate-800"
                          >
                            Editar
