...
export default function ImportarBancoIdentificadoPage() {
  ...
  function descargarPlantilla() {
    const ejemplo = [
      {
        ...
        monto: 4500,
        no_serial: "123456789",
        descripcion: "PAGO MANTENIMIENTO JUNIO L9-A1",
        apartamento: "L9-A1",
      },
      {
        fecha: "2026-06-15",
        monto: 4500,
        no_serial: "123456790",
        descripcion: "PAGO MANTENIMIENTO JUNIO L9-B2",
        apartamento: "L9-B2",
      },
      {
        fecha: "2026-06-30",
        monto: 4500,
        no_serial: "123456791",
        descripcion: "PAGO ADELANTADO O DEUDA L9-A1",
        apartamento: "L9-A1",
      },
    ];
    ...
    const instrucciones = [
      ...
      ["fecha", "Sí", "2026-06-01 o 01/06/2026", "Fecha real de entrada en banco."],
      ["monto", "Sí", "4500.00", "No usar RD$. Puede usar decimales."],
      ["no_serial", "Recomendado", "123456789", "Referencia o serial bancario. Ayuda a evitar duplicados."],
      ["descripcion", "No", "Pago mantenimiento", "Detalle del banco o nota interna."],
      ["apartamento", "Sí", "L9-A1", "Debe coincidir con el código de la unidad en VAM."],
    ];

    const libro = XLSX.utils.book_new();
    const hojaPlantilla = XLSX.utils.json_to_sheet(ejemplo, {
    ...
    const hojaInstrucciones = XLSX.utils.aoa_to_sheet([
      ["Plantilla para importar pagos bancarios identificados"],
      [],
      ...instrucciones,
      [],
      ["Reglas importantes"],
      ["1. No cambie los nombres de las columnas."],
      ["2. El apartamento debe venir como L9-A1, L9-B2, etc."],
      ["3. El mes del archivo se selecciona en la pantalla, no en el Excel."],
      ["4. Puede haber dos pagos del mismo apartamento en el mismo mes si son transacciones diferentes."],
      ["5. El sistema aplica el pago a los cargos pendientes usando la función central de pagos."],
    ]);
    ...
    XLSX.writeFile(libro, "Plantilla_pagos_banco_identificados.xlsx");
  }
  ...
  return (
    <PageContainer>
      ...
      <ModuleToolbar
        title="Archivo Banco Identificados"
        subtitle={`Subida mensual de pagos identificados por apartamento. Condominio: ${
          ...
          <ModuleActions
            ...
            extra={
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-xl border border-blue-200 bg-blue-50 px-4 py-2 text-sm font-black text-blue-700 hover:bg-blue-100"
              >
