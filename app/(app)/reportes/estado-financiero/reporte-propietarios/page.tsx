    ...
    <div id="reporte-propietarios-print-root" className="min-h-screen bg-slate-100 px-4 py-6 print:bg-white print:px-0 print:py-0 print:min-h-0">
      ...
      <main className="print-card mx-auto max-w-5xl rounded-3xl border border-slate-200 bg-white p-7 shadow-sm print:p-0">
        <header className="print-header border-b-4 border-blue-900 pb-5">
          <div className="flex items-start justify-between gap-5">
            <div>
              ...
              <p className="print-header-subtitle mt-2 text-sm text-slate-600">Reporte resumido basado en los movimientos reales del Control Bancario.</p>
            </div>
        ...
        <section className="print-section mt-6">
          ...
          <div className="print-summary-cards grid gap-3 md:grid-cols-5">
