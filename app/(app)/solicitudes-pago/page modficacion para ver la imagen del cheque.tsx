                      ...
                      <div className="flex flex-col items-center gap-2">
                        {esImagenCheque(g.cheque_url) ? (
                          ...
                          >
                            <img
                              src={g.cheque_url}
                              alt={`Cheque gasto ${g.id}`}
                              className="w-36 h-24 object-contain rounded-lg border bg-white shadow-sm"
                            />
                          </a>
                        ) : (
                          <div className="w-36 h-24 rounded-lg border bg-slate-100 flex items-center justify-center text-xs font-bold text-slate-600">
                            Archivo PDF
                          </div>
                        )}
