  ...
  return (
    <PageContainer>
      <ModuleMenu
        ...
        subtitle="Nueva solicitud, aprobaciones, gastos generados y reportes."
        tone="green"
        items={[
          { href: "/solicitudes-pago", label: "Listado", icon: ClipboardCheck },
          { href: "/solicitudes-pago/nueva", label: "Nueva Solicitud", icon: Plus },
          { href: "/solicitudes-pago/tesorero", label: "Tesorero", icon: ShieldCheck },
          { href: "/solicitudes-pago/presidente", label: "Presidente", icon: ShieldCheck },
          { href: "/solicitudes-pago/resumen", label: "Resumen", icon: BarChart3 },
      ...
      <ModuleToolbar
        ...
        subtitle="Complete los datos principales de la solicitud para iniciar el flujo de aprobación."
        icon={FileText}
        actions={
          <Link
        ...
        >
              ...
              <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                <div>
                  ...
                  <p className="mt-1 text-sm text-blue-800">
                    ...
                    colocó el monto sugerido automáticamente.
                  </p>
          ...
          <div>
            ...
            <input
              ...
              readOnly
              className="w-full rounded-xl border bg-slate-100 px-4 py-3 font-black text-blue-700"
            />
          </div>
          ...
          <div>
            <label className="mb-1 block text-sm font-semibold">NCF</label>
            <input
              type="text"
              value={ncf}
          ...
          <div className="flex flex-col gap-3 md:col-span-2 md:flex-row">
            ...
            <Link
              href="/solicitudes-pago"
              className="inline-flex items-center justify-center rounded-xl border bg-white px-5 py-3 font-bold text-slate-700 hover:bg-slate-50"
            >
              Cancelar
            </Link>
          </div>
