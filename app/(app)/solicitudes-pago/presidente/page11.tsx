...
export default function AprobacionPresidentePage() {
  ...
  async function actualizarEstado(id: number, nuevoEstado: string) {
    ...
    const { error } = await supabase
      ...
      .update({
        estado: nuevoEstado,
        comentario_presidente: comentario || null,
  ...
  return (
    <PageContainer>
      ...
      <ModuleToolbar
        title="Aprobación del Presidente"
        subtitle={`Solicitudes aprobadas por tesorería pendientes de decisión final. Condominio: ${
      ...
      <SectionCard
        title="Solicitudes para aprobación final"
        subtitle="Revise cada solicitud aprobada por tesorería y apruebe, solicite aclaración o rechace."
        action={
          loading ? (
      ...
      >
        {loading ? (
          ...
          <EmptyState
            ...
            description="No hay solicitudes pendientes de aprobación por el presidente para este condominio."
          />
        ) : (
                ...
                <div className="p-5">
                  ...
                  <div className="mt-5">
                    ...
                    <textarea
                      ...
                      rows={3}
                      placeholder="Comentario de aprobación final. Obligatorio si solicita aclaración o rechaza."
                    />
                  </div>
