...
export default function PruebaImpresionChequesPage() {
  ...
  useEffect(() => {
    try {
      const raw = sessionStorage.getItem(DATOS_PAGO_STORAGE_KEY);
      if (!raw) return;
      ...
      console.error("No fue posible cargar los datos del pago para impresión:", error);
    }
  }, []);
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mb-6 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              >
                {datosPago ? "Imprimir cheque" : "Imprimir prueba"}
              </button>
            </div>
          </div>
            ...
            <section className="space-y-5">
              <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                ...
                <div className="solo-pantalla mx-auto w-full max-w-[860px]">
                  ...
                  >
                    {/* Vista visual responsiva. La impresión real usa la plantilla calibrada oculta. */}
              ...
              {datosPago && (
                <div className="rounded-2xl border border-amber-200 bg-amber-50 p-4 text-sm leading-6 text-amber-900">
                  <strong>Control VAM:</strong> imprimir el cheque no registra todavía el
                  egreso bancario. Después de verificar la impresión, regrese al módulo
                  de pago y presione <strong>Registrar egreso bancario</strong>.
                </div>
              )}
