...
const CONFIG_INICIAL: Configuracion = {
  // LOTE 4 - calibración final Banco Popular 160 × 70 mm.
  fecha: { x: 104, y: 19, fontSize: 15 },
  beneficiario: { x: -23, y: 40, fontSize: 12.5 },
  monto: { x: 96, y: 38, fontSize: 14 },
  letras: { x: -50, y: 52, fontSize: 12 },
  comentario: { x: -50, y: 76, fontSize: 11.5 },
};
...
const CHEQUE_ANCHO_MM = 160;
const CHEQUE_ALTO_MM = 70;

const PLANTILLA_ID = "BANCO_POPULAR_LOTE4_EPSON_L4160_160X70_V1";
const PLANTILLA_NOMBRE = "Banco Popular · Lote 4 · 160 × 70 mm";
...
export default function PruebaImpresionChequesPage() {
  ...
  const copiarConfiguracion = async () => {
    const payload = {
      banco: "Banco Popular",
      plantilla: "Banco Popular - Lote 4 - 160x70",
  ...
  return (
    <>
      <style>{`
        ...
        @media print {
          @page {
            size: ${modoPapel === "cheque" ? "70mm 160mm" : "Letter"};
            margin: 0;
          }
          ...
          #zona-impresion {
            ...
            /*
              ...
              PRUEBA LOTE 4:
              - Papel personalizado: 70 mm ancho x 160 mm alto (Portrait).
              - El cheque físico mide 160 mm x 70 mm.
              - Se mantiene la entrada por lado corto y rotación -90°.
            */
            left: 0 !important;
            top: 160mm !important;
          ...
          <div className="mb-6 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Banco Popular · Lote 4 · Calibración 160 × 70 mm
              </p>
              {datosPago && (
              ...
              <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                <div className="mb-3 flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      Cheque físico: 160 × 70 mm · prueba de entrada: 70 × 160 mm
                    </p>
                  </div>
                ...
                {modoCalibracion ? (
                  <div className="solo-pantalla">
                    ...
                    <div className="overflow-auto rounded-xl border border-slate-300 bg-slate-100">
                      <div
                        className="relative"
                        style={{
                          width: `${CHEQUE_ANCHO_MM + 120}mm`,
                          height: `${CHEQUE_ALTO_MM + 100}mm`,
                          minWidth: `${CHEQUE_ANCHO_MM + 120}mm`,
                          minHeight: `${CHEQUE_ALTO_MM + 100}mm`,
                          paddingLeft: "60mm",
                          paddingRight: "60mm",
                          paddingTop: "40mm",
                          paddingBottom: "60mm",
                      ...
                      >
                        ...
                        {mostrarGuia && (
                          <div className="absolute inset-0 bg-[#ead19e]">
                            <div className="absolute left-[5mm] top-[4mm] text-[9px] font-bold leading-tight text-slate-700">
                              CONDOMINIO RESIDENCIAL COLINAS DEL OESTE
                              <br />
                              RNC. 430289002
                            </div>

                            <div className="absolute right-[8mm] top-[4mm] text-right text-[9px] font-semibold text-slate-700">
                              No. {numeroCheque}
                            </div>

                            <div className="absolute left-[5mm] top-[23mm] text-[8px] font-semibold text-slate-700">
                              PÁGUESE CONTRA ESTE
                              <br />
                              CHEQUE A LA ORDEN DE:
                            </div>

                            <div className="absolute left-[35mm] right-[47mm] top-[31mm] border-b border-slate-500" />

                            <div className="absolute right-[42mm] top-[24mm] text-[15px] font-bold text-slate-700">
                              RD$
                            </div>

                            <div className="absolute left-[5mm] right-[5mm] top-[39mm] border-b border-slate-500" />

                            <div className="absolute right-[5mm] top-[37mm] text-[8px] font-bold text-slate-700">
                              PESOS
                            </div>

                            <div className="absolute bottom-[9mm] left-[90mm] right-[5mm] border-b border-slate-500" />

                            <div className="absolute bottom-[5mm] left-[125mm] text-[7px] text-slate-600">
                              FIRMA(S)
                            </div>

                            <div className="absolute bottom-[8mm] left-[6mm] text-[18px] font-bold italic text-blue-800">
                              POPULAR
                            </div>
                          </div>
                        )}
                    ...
                    <p className="mt-2 text-center text-[11px] text-slate-500">
                      El borde azul representa el cheque físico de 160 × 70 mm.
                      Durante la calibración los textos pueden verse fuera de ese borde
                      para permitir coordenadas negativas o mayores al tamaño del cheque.
                      Esto no cambia la impresión física.
                    </p>
                  </div>
                ) : (
                <div className="solo-pantalla mx-auto w-full max-w-[860px]">
                  ...
                  <p className="mt-2 text-center text-[11px] text-slate-400">
                    Vista visual Lote 4. La impresión conserva la calibración física de 160 × 70 mm.
                  </p>
                </div>
                )}
              ...
              <div>
                <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      X mueve horizontalmente · Y mueve verticalmente. La vista extendida permite calibrar también valores negativos o fuera del borde visual.
                    </p>
                  </div>
                ...
                <div className="mt-3 rounded-xl border border-amber-200 bg-amber-50 p-3 text-xs leading-5 text-amber-900">
                  <strong>Comentario:</strong> en esta plantilla Epson algunas
                  coordenadas válidas de impresión pueden quedar fuera del rectángulo
                  visual de 160 × 70 mm debido a la rotación de la hoja y al origen
                  físico del driver. La vista extendida evita que el comentario
                  desaparezca mientras lo calibra.
                </div>
