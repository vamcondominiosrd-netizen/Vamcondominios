...
function firstDay(periodo: string) {
  return periodo ? `${periodo}-01` : "";
}
...
export default function AdminPagosPage() {
  ...
  async function cargarPagos() {
    ...
    if (periodoFiltro) {
      query = query
        .gte("fecha_pago", firstDay(periodoFiltro))
        .lt("fecha_pago", nextMonth(periodoFiltro));
    }
