...
export default function AdminPagosPage() {
  ...
  async function cargarPagos() {
    ...
    let query = supabase
      .from("pagos")
      .select(
        "id,client_id,condominio_id,unidad_id,fecha_pago,periodo,monto,metodo,metodo_pago,referencia,descripcion,origen,cuenta_bancaria_id,tipo_fondo,comprobante_url,created_at"
      )
      .eq("condominio_id", condominioId)
          ...
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-600">
                Corrige pagos registrados, sincroniza cargos y Control Bancario, y permite consultar o reemplazar el comprobante sin eliminar el soporte anterior.
              </p>
            </div>
