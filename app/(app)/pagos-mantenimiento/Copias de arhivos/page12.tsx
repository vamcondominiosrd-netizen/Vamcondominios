...
export default function PagosMantenimientoPage() {
  ...
  async function guardarPago(e: React.FormEvent, imprimirRecibo = false) {
    e.preventDefault();
    setMensaje("");
    ...
    try {
      ...
      if (imprimirRecibo) {
        router.push(`/pagos-mantenimiento/recibo/${pagoInsertado.id}`);
        return;
      }
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col gap-3 md:col-span-2 md:flex-row">
                ...
                <button
                  type="button"
                  onClick={(e) => guardarPago(e as any, true)}
                  disabled={guardando}
