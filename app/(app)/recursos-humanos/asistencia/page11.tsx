...
export default function AsistenciaPage() {
  ...
  async function cargarAsistencias(id: string, fechaBuscar: string) {
    ...
    if (fechaBuscar) query = query.eq("fecha", fechaBuscar);
  ...
  async function eliminarAsistencia(a: Asistencia) {
    const confirmar = confirm(`¿Seguro que desea eliminar la asistencia de ${a.nombre_empleado}?`);
    if (!confirmar) return;
        ...
        <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="text-sm text-slate-500">
              Registro diario de entradas, salidas, tardanzas y permisos.
            </p>
          </div>
