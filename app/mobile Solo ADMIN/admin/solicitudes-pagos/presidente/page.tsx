...
export default function MobileAprobacionPresidentePage() {
  ...
  return (
    <main className="min-h-screen bg-slate-100 pb-24">
      <section className="bg-indigo-700 text-white rounded-b-3xl p-5 shadow">
        ...
        <h1 className="text-2xl font-black mt-3">Firma Presidente</h1>
      ...
      <section className="p-4 space-y-4">
        ...
        <div className="bg-white rounded-2xl border shadow-sm p-4">
          <p className="text-xs text-slate-500">Monto pendiente decisión</p>
        ...
        <div className="bg-white rounded-2xl border shadow-sm p-4">
          ...
          <p className="text-sm text-slate-500 mt-1">
            Revise la solicitud, el soporte y el comentario del tesorero antes
